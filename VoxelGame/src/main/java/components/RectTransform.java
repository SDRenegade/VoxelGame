...
public class RectTransform extends Transform {
    ...
    public RectPivot getAnchor() { return anchor; }

    public void setAnchor(RectPivot anchor) { this.anchor = anchor; }

    public RectPivot getPivot() { return pivot; }

    public void setPivot(RectPivot pivot) { this.pivot = pivot; }
}
